    ...
    public class Simulator
    {
        ...
        private class Worker
        {
            ...
            internal void step(object obj)
            {
                ...
                {
                    if (Simulator.instance_.agents_[index].needNewVelocity_ == false) { Simulator.Instance.agents_[index].newVelocity_ = new Vector2(0, 0);  continue; }
        ...
        public void StopAgent(int agentNo) 
        {
            agents_[agentNo2indexDict_[agentNo]].needNewVelocity_=false;
        }

        public void StartAgent(int agentNo)
        {
            if (agents_[agentNo2indexDict_[agentNo]].needNewVelocity_ != true)
            agents_[agentNo2indexDict_[agentNo]].needNewVelocity_ = true;
        }
